                    ...
                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group {{ $errors->first('e_name') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" name="e_name" value="e_name" placeholder="Name ...">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group {{ $errors->first('e_link') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" name="e_link" value="e_link"  placeholder="Link ...">
                            ...
                            <div class="row">
                                <div class="col-sm-2">
                                    <div class="form-group ">
                                        ...
                                        <input type="checkbox" name="e_position_1" value="1" {{ $event->e_position_1 ?? 0 == 1 ? "checked = 'checked'" : "" }}>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group ">
                                        <label for="name">Home 2</label>
                                        <input type="checkbox" name="e_position_2" value="1" {{ $event->e_position_2 ?? 0 == 1 ? "checked = 'checked'" : "" }}>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group ">
                                        <label for="name">Home 3</label>
                                        <input type="checkbox" name="e_position_3" value="1" {{ $event->e_position_3 ?? 0 == 1 ? "checked = 'checked'" : "" }}>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group ">
                                        <label for="name">Home 4</label>
                                        <input type="checkbox" name="e_position_4" value="1" {{ $event->e_position_4 ?? 0 == 1 ? "checked = 'checked'" : "" }}>
                                    </div>
                                </div>
                            </div>
                        </div>
