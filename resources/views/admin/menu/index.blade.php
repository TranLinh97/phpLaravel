                                ...
                                @if($menus)
                                    @foreach($menus as $menu)
                                        <tr>
                                            ...
                                            <td>
                                               <a href="{{route('admin.menu.update',$menu->id)}}" class="btn btn-success"><i class="fa fa-pencil"></i> Edit</a>
                                               <a href="{{route('admin.menu.delete',$menu->id)}}" class="btn btn-danger"><i class="fa fa-trash"></i> Delete</a>
                                            </td>
