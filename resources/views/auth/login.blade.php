        ...
        <div class="auth" style="background: white;">
            <form class="from_cart_register" action="" method="post" style="width: 500px;margin:0 auto;padding: 30px 0">
                ...
                <div class="form-group">
                    ...
                    <a href=" {{--{{ route('login.gg') }}--}} " class="btn btn-primary btn-sm"><i class="fa fa-google"></i> Google</a>
                    <a href="{{--{{ url('/auth/redirect/facebook') }}--}}" class="btn btn-primary btn-sm"><i class="fa fa-facebook"></i> Facebook</a><br/>
