...
@section('content')
    <section class="py-lg-3" style="background: white;padding: 20px">
        <div class="title" style="text-align: center"> <h2>Cập nhật thông tin</h2></div>
            <div class="col-sm-12">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" readonly name="email" value="{{ Auth::user()->email }}" placeholder="Enter email">
                        {{-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> --}}
                    </div>
                    <div class="form-group">
