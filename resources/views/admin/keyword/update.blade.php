                    ...
                    <form role="form" action="" method="post">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group {{$errors->first('k_name') ? 'has-error':''}}" >
                                ...
                                <input type="text" class="form-control" name="k_name" value="{{$keyword->k_name}}" placeholder="Name...">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group" >
                                ...
                                <textarea type="text" class="form-control" name="k_description" placeholder="Description...">{{$keyword->k_description}}</textarea>
