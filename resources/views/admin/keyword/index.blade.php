                                ...
                                @if(isset($keywords))
                                    @foreach($keywords as $keyword)
                                        <tr>
                                            ...
                                            <td>
                                               <a href="{{route('admin.keyword.update',$keyword->id)}}" class="btn btn-success"><i class="fa fa-pencil"></i> Edit</a>
                                               <a href="{{route('admin.keyword.delete',$keyword->id)}}" class="js-delete-confirm btn btn-danger"><i class="fa fa-trash"></i> Delete</a>
                                            </td>
