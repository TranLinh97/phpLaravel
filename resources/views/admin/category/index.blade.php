                                ...
                                @if($categories)
                                    @foreach($categories as $category)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="https://thailamlandscape.vn/wp-content/uploads/2017/10/no-image.png" style="width: 80px;height: 80px">
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                               <a href="{{route('admin.category.update',$category->id)}}" class="btn btn-success"><i class="fa fa-pencil"></i> Edit</a>
