                ...
                <div class="customer">
                    ...
                    <div class="customer__content">
                        <form class="from_cart_register" action="{{route('post.shopping.pay')}}" method="post">
                            ...
                            <div class="form-group">
                                <label for="address">Địa chỉ giao hàng <span class="cRed">(*)</span></label>
                            ...
                            <div class="form-group">
                                ...
                                <input readonly   name="tst_email" id="email" required=""  type="text"  value="{{ get_data_user('web','email') }}" class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="btn-buy">
                                ...
                                <a href="" class="buy1 btn btn-purple" >
                                    Thanh toán online
                                </a>
                            </div>
                        </form>
